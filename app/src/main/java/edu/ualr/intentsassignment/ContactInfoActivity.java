...
public class ContactInfoActivity extends AppCompatActivity {
    ...
    // TODO 04. Define the basic skeleton of the ContactInfoActivity. Inflate the
    //  layout defined in the first step to display the GUI elements on screen.
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // TODO 07. Create a new method that reads the contact info
        //  coming from ContactFormActivity and use it to populate the several TextView elements in the layout.
    ...
    public void onCallClick(View view) {
        // TODO 08. Create a new method that invokes a Phone Dialer app, using as parameter
        //  the phone number included in the contact info received from ContactFormActivity in the previous step
    ...
    public void onSMSClick(View view) {
        // TODO 09. Create a new method that invokes a Messages app, using as parameter
        //  the phone number included in the contact info received from ContactFormActivity in the 7th step
    ...
    // TODO 11. Create a new method that invokes an Email app,
    //  using as parameter the email address included in the contact info received from ContactFormActivity in the 7th step
    ...
    // TODO 12. Create a new method that invokes an Web Browser app,
    //  using as parameter the web url included in the contact info received from ContactFormActivity in the 7th step
